...
export const event: Event = {
    ...
    async run(client, interaction: Interaction){
        ...
        if(!command){
            return interaction.followUp({content: "Whoops... we cant find this command :/"})
        }
        ...
        if(!member){
            return interaction.followUp({content: "Yikes... we couldnt find your indentity on this server."})
        }
